        ...
        <Stack direction='row' spacing='4'>
          ...
          {modals.map((modal) => (
            <Box key={modal.id} borderWidth='1px' borderRadius='md' p='4' boxShadow='md'>
              <OpenModal keyId={modal.id} inputData={modal.inputData} assetName="Business" url = {"/api/assets/updateaddassets"} ReqVal={"Value"} OptString={"OptString"} FormVals={["Enter Business Name", "Set your Asset Assignment", "Enter Business Value", "Enter Specific Clauses (optional)"] } />
