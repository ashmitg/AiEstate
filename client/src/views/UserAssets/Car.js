        ...
        <Stack direction='row' spacing='4'>
          ...
          {modals.map((modal) => (
            <Box key={modal.id} borderWidth='1px' borderRadius='md' p='4' boxShadow='md'>
              <OpenModal keyId={modal.id} inputData={modal.inputData} assetName="Car" url = {"/api/assets/updateaddassets"} ReqVal={"Value"} OptString={"OptString"} FormVals={["Enter Car Name", "Set your Asset Assignment", "Enter Car Value", "Enter Specific Clauses (optional)"] } />
